...
/// The default is the system font in a size that scales with the iOS Text Size setting; the default may be restored by setting this property to `nil`.
...
/// The default is a cross that scales with `barHeight`; the default may be restored by setting this property to `nil`.
